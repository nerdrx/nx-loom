...
def _bpy_modules():
    ...
    from .ops import bake as ops_bake
    ...
    from .ops import radial as ops_radial
    from .ops import retarget as ops_retarget
    from .ops import stamps as ops_stamps
    from .ops import suggest as ops_suggest
    ...
    return properties, (ops_jobs, ops_layout, ops_draw, ops_brush,
                        ops_bake, ops_lods, ops_radial, ops_retarget,
                        ops_suggest, ops_stamps, ui_panel, ui_tools,
                        ui_overlay)
